...
export class DoofinderResult {
  ...
  private loadFacets(facetObj: GenericObject): void {
    this._facets = Object.keys(facetObj).map((key: string): Facet => {
  ...
  public get results(): SingleResult[] { return this._results };
  public get page(): number { return this.page };
  public get total_found(): number { return this._total_found;};
  public get max_score(): number { return this._max_score;};
  public get query_name(): QueryTypes { return this._query_name;};
  public get query(): string { return this._query;};
  public get results_per_page(): number { return this._results_per_page;};
  public get facets(): Facet[] { return this._facets;};
  public get filters(): FilterResponse { return this._filters;};
  public get raw(): GenericObject { return this._raw;};
