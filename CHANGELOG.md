...
## [5.13.4] - 2021-05-03
### Fixed
- Fix token authentication format and dev environment.
...
## [5.12.0] - 2020-05-18
### Added
- Added new session store based on Local Storage.

## [5.11.0] - 2020-05-13
### Added
- Added cart methods for stats.

## [5.10.1] - 2019-12-23
### Fixed
- Fixed a bug that made facets not work properly.

## [5.10.0] - 2019-12-02
### Changed
- Now you can whitelist parameters when serializing status.

## [5.9.0] - 2019-11-11
### Added
- Added new `escape-attr-value` template function.
- Added new `getItems()` endpoint in client.
...
## [5.8.0] - 2019-07-09
### Fixed
- DfDom can select SVGElement nodes (#162).

### Changed
- Updated noUiSlider to 13.1.5

## [5.7.0] - 2019-03-12
### Added
- Added search response processors feature.
...
## [5.6.3] - 2018-12-20
### Added
- Support for mustache tags in translations.
...
## [5.6.0] - 2018-11-28
### Added
- New `EventEnabled` class to enable events in a class.
- New `ScrollManager` class to allow managing scrolling in custom stuff.

### Changed
- Refactored `Controller` to use `EventEnabled`.
- Refactored `ScrollDisplay` to use ` ScrollManager`.
- Session cookie expiry set to 24h by default.

## [5.5.0] - 2018-11-05
### Added
- Display can accept the insertion method used by render() function.
- The valid insertion methods are: "prepend", "append", "before", "after", "html". Default: "html"
