...
|  [order](./doofinder.rawtermsfacet.order.md) | number | <b><i>(BETA)</i></b> How pertinent is the facet compared to the other facets in the response. If only one facet could be displayed, it should be the one with the highest order. |
